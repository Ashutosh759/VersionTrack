...
import { GitBranch, Lock, Mail, User, AlertCircle } from 'lucide-react';
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-center text-xs font-mono text-zinc-500">
            Start tracking versions and collaborating
          </p>
        </div>
        ...
        <div className="border border-zinc-800 bg-zinc-900/25 p-6 rounded-lg space-y-6">
          ...
          <div className="text-center">
            <span className="text-xs font-mono text-zinc-500">
              ...
              <Link to="/login" className="text-zinc-300 hover:text-white underline">
                Sign in
              </Link>
            </span>
          </div>
